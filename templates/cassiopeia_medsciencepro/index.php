    ...
    <header class="header container-header full-width<?php echo $stickyHeader ? ' ' . $stickyHeader : ''; ?>">
        ...
        <?php if ($this->countModules('menu', true) || $this->countModules('search', true)) : ?>
            <div class="grid-child container-nav">
                ...
                <div class="d-lg-none">
                    <jdoc:include type="modules" name="mobile-custom-nav" style="none" />
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('#my-mobile-menu li.parent > a').forEach(link => {
...
<script src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/js/mobile-nav.js"></script>

<script>
document.addEventListener("DOMContentLoaded", function() {
    // 1. Check if the URL has the hash
    if (window.location.hash === "#pdf-list") {
        
        // 2. Target the specific accordion collapse (collapse-18)
        var targetCollapse = document.getElementById("collapse-18");
        
        if (targetCollapse) {
            // 3. Open the accordion using Bootstrap's API
            var bsCollapse = new bootstrap.Collapse(targetCollapse, {
                toggle: true
            });
            
            // 4. Wait for the accordion animation to finish (approx 300-500ms)
            // then scroll the list into view
            setTimeout(function() {
                var listElement = document.getElementById("pdf-list");
                if (listElement) {
